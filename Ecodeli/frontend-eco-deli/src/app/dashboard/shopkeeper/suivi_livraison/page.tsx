...
export default function DeliveryTracking() {
  ...
  const handleSubmitReport = async () => {
    ...
    try {
        ...
        router.push(`/dashboard/shopkeeper/chat/${admins[0].id}?packageId=${packageId}`)
    } catch (err: any) {
      ...
      <main className="p-5 md:p-10 w-full max-w-screen-2xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          ...
          <button
            ...
            onClick={() => router.push("/dashboard/shopkeeper/createAnnounce")}
                  ...
                  {expandedAdId === ad.id && (
                    ...
                    >
                      ...
                      <div className="mt-6 flex justify-end">
                        <button
                          onClick={() => router.push(`/dashboard/shopkeeper/announcementPage/${ad.id}`)}
